...
export const uiTranslations = {
  hu: {
    ...
    contactNote: "A beszélgetés e-mailben indul, nem kell kész specifikáció.",
    contactTrustNotes: ["Nem kell kész specifikáció", "Közvetlenül velünk beszélsz", "1-2 munkanapon belül válaszolunk"],
    case: {
  ...
  en: {
    ...
    contactNote: "The conversation starts by email; you do not need a finished specification.",
    contactTrustNotes: ["No finished specification needed", "You talk directly with us", "We reply within 1-2 working days"],
    case: {
  ...
  de: {
    ...
    contactNote: "Das Gespräch beginnt per E-Mail; eine fertige Spezifikation ist nicht nötig.",
    contactTrustNotes: ["Keine fertige Spezifikation nötig", "Du sprichst direkt mit uns", "Wir antworten innerhalb von 1-2 Werktagen"],
    case: {
