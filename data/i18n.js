...
export const uiTranslations = {
  ...
  en: {
    ...
    contactConversationText: "We do not send template proposals. First we understand the situation, then outline a realistic first version of the system.",
    ...
    contactStarterPrompts: ["who the site or system is for", "what is hard to manage today", "what content or workflow should be handled", "whether there is an existing site or admin", "when launch would ideally happen"],
    ...
    case: {
      ...
      bottomText: "You do not need a finished brief. A short description of the site, admin interface or web tool is enough to start.",
  ...
  en: {
    siteContent: {
      ...
      hero: {
        ...
        subheadline: "We build editable websites, admin interfaces and focused web tools for municipalities, institutions and small businesses.",
        primaryCta: "Let’s talk about the project",
        secondaryCta: "See what we build",
      },
      problem: {
        title: "Most websites go live. Then they become hard to use.",
        text: "Many organizations do not need another static website. They need something the team can actually use: publish news, upload documents, receive forms, follow workflows and keep the site running safely.",
        painPoints: [
      ...
      process: {
        ...
        intro: "As a small team, we work directly with you: first we understand what the system needs to support, then we build the structure, interface and operating basics around it.",
        steps: [
          { title: "Understand", text: "We get to know the goal, users, current problems and what the system needs to solve." },
          { title: "Plan", text: "We shape the page structure, content types, admin setup and required functions." },
      ...
      whyCodeNest: {
        title: "Why CodeNest?",
        intro: "We do not work through a large agency chain. Two people, direct communication and a practical mindset behind every web system.",
        items: [
          ...
          { title: "Reliable operating basics", text: "Hosting, backups, updates, access and support are part of the system, not afterthoughts." },
        ],
      },
      scope: {
        title: "Every project starts with scope.",
        text: "We do not start from fixed public packages. First we understand how the web system will be used, then define the scope, technical foundation and post-launch operation around that.",
      ...
      contact: {
        ...
        projectTypes: ["Municipal / institutional portal", "Admin-backed business website", "Custom web tool", "Rethinking an existing site", "I am not sure yet"],
      },
      footer: {
    ...
    services: {
      "onkormanyzati-es-intezmenyi-portalok": {
        title: "Municipal and institutional portals",
        shortDescription: "Clear, editable portals for news, documents, events and public information.",
        supportingText: "We build portals where the public website and the editorial admin work from the same organized content foundation. The goal is a site that can be maintained after launch, not a static surface that slowly gets stuck.",
        features: ["News, events and notices", "Document library and downloads", "Editable pages and menu structure", "Forms, reports and simple workflows"],
        chips: ["portal", "admin", "documents", "forms"],
        ctaLabel: "Let’s talk about the project",
      },
      "adminos-uzleti-weboldalak": {
        title: "Admin-backed business websites",
        shortDescription: "Business websites where services, references, requests and content blocks can be updated in-house.",
        supportingText: "For small businesses and service providers, we build websites with a usable admin interface. This keeps everyday content manageable after launch instead of turning every update into developer work.",
        features: ["Editable services and pages", "References, images and content blocks", "Contact and request forms", "Hosting, backup and maintenance"],
        chips: ["editable website", "admin", "requests", "support"],
        ctaLabel: "Let’s talk about the project",
      },
      "egyedi-webes-eszkozok": {
        title: "Custom web tools",
        shortDescription: "Focused internal tools, calculators, data views and workflows for concrete operational problems.",
        supportingText: "When the task is too specific for a template but does not need a huge enterprise system, we build a focused web tool around it. Clear data, usable screens and a workflow that fits daily work matter most.",
        features: ["Custom forms and data handling", "Internal admin or dashboard views", "Simple permission logic", "Exports, notifications and workflow steps"],
        chips: ["web tool", "workflow", "dashboard", "data"],
        ctaLabel: "Let’s talk about the project",
      },
    },
    projects: {
      "gardony-platform": {
        ...
        shortDescription: "Municipal portal with news, documents, events and editable admin workflows.",
        ...
        caseStudy: {
          ...
          visualText: "The screenshots show how Gárdony Platform connects public content with internal editorial workflows.",
          ...
          takeaway: "This is the clearest example of what CodeNest means by a web system: not only a public website, but something the organization can actually use.",
        },
      },
      "ildiko-fonad": {
    ...
    teamIntro: { title: "Two people stay with the project.", text: "CodeNest is run by Bors and Dávid. As a small, focused studio, we take on fewer projects at once, but stay directly involved from the first conversation to launch.", trustNotes: ["Direct communication", "Faster decisions", "Fewer misunderstandings", "More personal collaboration"] },
    team: { Bors: { role: "System logic, backend, admin interfaces", shortText: "Keeps the system logic, data structures, admin interfaces and technical foundations in shape." }, "Dávid": { role: "Frontend, UX, project communication", shortText: "Keeps the user experience, visual implementation and shared project rhythm aligned." } },
  },
  de: {
    siteContent: {
      navigation: { items: [
      ...
      hero: { headline: "Websysteme, die man nicht nur ansehen, sondern wirklich nutzen kann.", subheadline: "Wir bauen editierbare Websites, Adminoberflächen und fokussierte Webtools für Gemeinden, Institutionen und kleine Unternehmen.", primaryCta: "Über das Projekt sprechen", secondaryCta: "Ansehen, was wir bauen" },
      problem: { title: "Die meisten Websites gehen online. Danach sind sie schwer zu nutzen.", text: "Viele Organisationen brauchen keine weitere statische Website, sondern etwas, das das Team wirklich nutzen kann: Nachrichten veröffentlichen, Dokumente hochladen, Formulare empfangen, Abläufe verfolgen und den Betrieb im Blick behalten.", painPoints: [{ title: "Schwer zu aktualisieren", text: "Inhalte veralten, weil jede kleine Änderung Abstimmung oder Entwicklerhilfe braucht." }, { title: "Verstreute Inhalte", text: "Dokumente, Nachrichten und Informationen liegen an zu vielen Orten." }, { title: "E-Mail-Chaos", text: "Anfragen, Bewerbungen und Meldungen können im Posteingang leicht untergehen." }, { title: "Keine klare Übergabe", text: "Die Website ist fertig, aber Pflege, Updates und Betrieb sind nicht immer klar." }], beforeAfter: { before: ["Verstreute Inhalte", "Abhängigkeit von Entwicklern", "E-Mail-Chaos"], after: ["Editierbarer Admin", "Geordnete Inhalte", "Transparenter Ablauf"] }, solution: "Wir bauen Websysteme, die nicht nur gut aussehen, sondern nach der Übergabe nutzbar, editierbar und langfristig betreibbar bleiben." },
      process: { title: "Ein klarer Prozess ohne unnötige Schleifen.", intro: "Als kleines Team arbeiten wir direkt mit dir: zuerst verstehen wir, was das System im Alltag unterstützen soll, danach bauen wir Struktur, Oberfläche und Betriebsgrundlage darum herum.", steps: [{ title: "Verstehen", text: "Wir lernen Ziel, Nutzer, aktuelle Probleme und die Aufgabe des Systems kennen." }, { title: "Planen", text: "Wir strukturieren Seiten, Inhaltstypen, Adminlogik und notwendige Funktionen." }, { title: "Bauen", text: "Wir erstellen Website, Adminoberfläche, Formulare, Integrationen und technische Grundlage." }, { title: "Übergeben", text: "Wir schulen, dokumentieren, übergeben Zugänge und unterstützen beim Launch." }, { title: "Betreiben", text: "Bei Bedarf helfen wir mit Hosting, Backups, Updates, Support und Weiterentwicklung." }] },
      whyCodeNest: { title: "Warum CodeNest?", intro: "Wir arbeiten nicht über eine große Agenturkette. Zwei Menschen, direkte Kommunikation und ein praktischer Blick auf jedes Websystem.", items: [{ title: "Direkte Kommunikation", text: "Du sprichst mit den Menschen, die das System verstehen und bauen." }, { title: "Editierbarer Admin", text: "Wir übergeben keine geschlossene Box. Kundinnen und Kunden können Inhalte und Abläufe selbst pflegen." }, { title: "Betreibbare Grundlage", text: "Hosting, Backup, Updates, Zugänge und Support sind Teil des Systems." }] },
      scope: { title: "Jedes Projekt startet mit einem klaren Umfang.", text: "Wir starten nicht mit öffentlichen Fixpaketen. Zuerst verstehen wir, wie das Websystem genutzt werden soll, und klären daraus Umfang, technische Grundlage und Betrieb.", summaryPoints: ["Das Angebot basiert auf Website, Adminoberfläche, Inhaltsstruktur und Abläufen, die wirklich gebraucht werden.", "Nicht alles muss sofort gebaut werden: wir trennen Startumfang und spätere Erweiterungen.", "Nach der Abstimmung bekommst du einen verständlichen Vorschlag."], includesTitle: "Was klären wir?", includes: ["Funktionen und Seitentypen", "Adminoberfläche und Rechte", "Inhaltstypen und Editierlogik", "Formulare, Benachrichtigungen und Workflows", "Hosting, Backup und Support", "Optionen für spätere Erweiterung"], ctaLabel: "Über das Projekt sprechen" },
      contact: { title: "Lass uns über dein Projekt sprechen.", text: "Du brauchst kein fertiges Briefing. Beschreibe kurz, woran ihr arbeitet, was heute schwer zu verwalten ist oder was ihr als Nächstes braucht.", emailLabel: "E-Mail", formLabels: { name: "Name", email: "E-Mail", projectType: "Projekttyp", message: "Nachricht", submit: "Über das Projekt sprechen" }, projectTypes: ["Kommunales / institutionelles Portal", "Business-Website mit Admin", "Individuelles Webtool", "Bestehende Website neu denken", "Ich weiß es noch nicht"] },
    ...
    projects: {
      ...
      "gardony-platform": {
        ...
        shortDescription: "Kommunales Portal mit Nachrichten, Dokumenten, Veranstaltungen und editierbaren Admin-Workflows.",
        ...
        caseStudy: {
          ...
          takeaway: "Das zeigt am klarsten, was CodeNest mit einem Websystem meint: nicht nur eine öffentliche Website, sondern etwas, das die Organisation wirklich nutzen kann.",
        },
      },
      "ildiko-fonad": {
    ...
    team: { Bors: { role: "Systemlogik, Backend, Adminoberflächen", shortText: "Hält Systemlogik, Datenstrukturen, Adminoberflächen und technische Grundlagen zusammen." }, "Dávid": { role: "Frontend, UX, Projektkommunikation", shortText: "Hält Nutzererlebnis, visuelle Umsetzung und gemeinsamen Projektrhythmus zusammen." } },
  },
};
