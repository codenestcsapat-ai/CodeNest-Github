...
const translations = {
  ...
  de: {
    siteContent: {
      ...
      hero: { headline: "Klare Websites, die spaeter leicht aktualisiert werden koennen.", subheadline: "Als junges ungarisches Unternehmen helfen wir kleineren Gemeinden, Institutionen und Betrieben mit Websites, auf denen Besucher schnell finden, was sie brauchen.", primaryCta: "Kurz darueber sprechen", secondaryCta: "Ansehen, wie wir helfen" },
      problem: { title: "Eine Website ist n?tzlich, wenn man sich leicht zurechtfindet.", text: "Viele Organisationen brauchen keine weitere statische Website, sondern etwas, das das Team wirklich nutzen kann: Nachrichten veröffentlichen, Dokumente hochladen, Formulare empfangen, Abläufe verfolgen und den Betrieb im Blick behalten.", painPoints: [{ title: "Schwer zu aktualisieren", text: "Inhalte veralten, weil jede kleine Änderung Abstimmung oder Entwicklerhilfe braucht." }, { title: "Verstreute Inhalte", text: "Dokumente, Nachrichten und Informationen liegen an zu vielen Orten." }, { title: "E-Mail-Chaos", text: "Anfragen, Bewerbungen und Meldungen können im Posteingang leicht untergehen." }, { title: "Keine klare Übergabe", text: "Die Website ist fertig, aber Pflege, Updates und Betrieb sind nicht immer klar." }], beforeAfter: { before: ["Verstreute Inhalte", "Schwere Aktualisierung", "Unklarer Kontaktweg"], after: ["Leichte Aktualisierung", "Geordnete Inhalte", "Gut am Handy"] }, solution: "Wir bauen Websites, die nicht nur gut aussehen, sondern nach der Übergabe nutzbar, editierbar und langfristig betreibbar bleiben." },
      process: { title: "Ein einfacher Prozess mit klaren Schritten.", intro: "Wir machen es nicht komplizierter als noetig. Zuerst klaeren wir, was die Website leisten soll, wer sie nutzt und welche Inhalte wichtig sind.", steps: [{ title: "Verstehen", text: "Wir lernen Ziel, Nutzer, aktuelle Probleme und die Aufgabe der Website kennen." }, { title: "Ordnen", text: "Wir ordnen Seiten, Texte, Bilder, Dokumente, Formulare und Kontaktpunkte." }, { title: "Bauen", text: "Wir erstellen die Website und, wenn sinnvoll, eine leicht pflegbare Inhaltsstruktur." }, { title: "Uebergeben", text: "Wir erklaeren die Nutzung, uebergeben Zug?nge und helfen beim Start." }, { title: "Spaeter helfen", text: "Wenn spaeter Fragen, kleine Aenderungen oder technische Einstellungen auftauchen, koennen wir weiterhelfen." }] },
      whyCodeNest: { title: "Warum CodeNest?", intro: "Wir sprechen nicht wie eine grosse Firma. Zwei Menschen arbeiten direkt mit dir und bauen Websites, die Kunden verstehen und nutzen koennen.", items: [{ title: "Direkte Kommunikation", text: "Du sprichst mit den Menschen, die die Website wirklich bauen." }, { title: "Leichte Aktualisierung", text: "Das Ziel ist einfach: wichtige Inhalte sollen spaeter auch ohne Entwicklerhilfe aktualisiert werden koennen." }, { title: "Klare ?bergabe", text: "Wir achten auf Domain, Zug?nge, Aktualisierungen, Start und externe Konten, damit es spaeter nicht unklar bleibt." }] },
      scope: { title: "Zuerst kl?ren wir die Aufgabe, nicht ein Paket.", text: "Wir starten nicht mit öffentlichen Fixpaketen. Zuerst verstehen wir, wie das Website genutzt werden soll, und klären daraus Umfang, technische Grundlage und Betrieb.", summaryPoints: ["Das Angebot basiert auf Website, Adminoberfläche, Inhaltsstruktur und Abläufen, die wirklich gebraucht werden.", "Nicht alles muss sofort gebaut werden: wir trennen Startumfang und spätere Erweiterungen.", "Nach der Abstimmung bekommst du einen verständlichen Vorschlag."], includesTitle: "Was klären wir?", includes: ["Funktionen und Seitentypen", "Adminoberfläche und Rechte", "Inhaltstypen und Editierlogik", "Formulare und Kontaktpunkte", "Start-Einstellungen und ?bergabe", "Optionen für spätere Erweiterung"], ctaLabel: "Über das Projekt sprechen" },
      contact: { title: "Lass uns kurz darueber sprechen.", text: "Du brauchst kein fertiges Briefing. Schreib kurz, woran ihr arbeitet oder was heute schwer zu pflegen ist; wir helfen beim naechsten sinnvollen Schritt.", emailLabel: "E-Mail", formLabels: { name: "Name", email: "E-Mail", projectType: "Projekttyp", message: "Nachricht", submit: "Kurze Nachricht senden" }, projectTypes: ["Gemeinde- oder institutionelle Website", "Website fuer lokale Unternehmen oder Fachleute", "Unterkunfts- oder Tourismus-Website", "Bestehende Website neu denken", "Ich weiss es noch nicht"] },
    ...
    services: {
      "onkormanyzati-es-intezmenyi-portalok": { title: "Gemeinden und Institutionen", shortDescription: "Klare, leicht aktualisierbare Websites fuer Nachrichten, Dokumente, Termine und Kontaktinformationen.", supportingText: "Wir helfen kleineren Gemeinden und Institutionen, wichtige Informationen verstaendlich und schnell auffindbar zu machen.", features: ["Nachrichten und Mitteilungen", "Dokumente und Downloads", "Spaeter aktualisierbare Inhalte", "Kontakt- und Anfragepunkte"], chips: ["Gemeinde", "Dokumente", "Kontakt", "Mobil"], ctaLabel: "Kurz darueber sprechen" },
      "adminos-uzleti-weboldalak": { title: "Lokale Unternehmen und Fachleute", shortDescription: "Websites, die Angebot, Bilder, Referenzen und Kontaktwege klar zeigen.", supportingText: "Fuer kleine Unternehmen und Dienstleister bauen wir Websites, die verstaendlich wirken und spaeter leichter pflegbar bleiben.", features: ["Leistungen und Unterseiten", "Bilder und Referenzen", "Kontakt- und Anfrageformulare", "Start-Einstellungen und spaetere Hilfe"], chips: ["Business", "Leistungen", "Anfragen", "Kontakt"], ctaLabel: "Kurz darueber sprechen" },
      "egyedi-webes-eszkozok": { title: "Unterkuenfte und Tourismus-Websites", shortDescription: "Klare Websites fuer Unterkuenfte, Orte und touristische Angebote.", supportingText: "Wir zeigen Bilder, Informationen, Leistungen und Kontaktwege so, dass Besucher auch am Handy schnell weiterkommen.", features: ["Bilder und Galerie", "Anfrage- und Kontaktwege", "Informationen fuer Gaeste", "Spaeter pflegbare Inhalte"], chips: ["Tourismus", "Galerie", "Kontakt", "Mobil"], ctaLabel: "Kurz darueber sprechen" },
    },
    projects: {

      "gardony-platform": {
        category: "Gemeinde / Institution",
        shortDescription: "Gemeinde-Website mit Nachrichten, Dokumenten, Terminen und spaeter aktualisierbaren Inhalten.",
