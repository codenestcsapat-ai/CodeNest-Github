...
function avatarMarkup(u,cls=''){
  ...
  return u.avatarData
    ? `<span class="avatar ${cls}"><img src="${esc(safeUrl(u.avatarData, true))}" alt="${esc(u.displayName)}" style="transform:translate(calc(-50% + ${x}px),calc(-50% + ${y}px)) scale(${scale})"></span>`
